    ...
    >
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-1">
          ...
          <a
            href="#contact"
            className="ml-4 px-5 py-2 text-sm font-semibold bg-gradient-to-r from-indigo-500 to-violet-600 text-white rounded-lg shadow-lg shadow-indigo-500/25 hover:shadow-indigo-500/40 hover:scale-105 transition-all"
          >
            Hire Me
          </a>
        </nav>
          ...
          >
            <div className="px-6 py-4 flex flex-col gap-2">
              ...
              <a
                href="#contact"
                onClick={() => setOpen(false)}
                className="mt-2 py-2 px-4 text-center font-semibold bg-gradient-to-r from-indigo-500 to-violet-600 text-white rounded-lg"
              >
                Hire Me
              </a>
            </div>
